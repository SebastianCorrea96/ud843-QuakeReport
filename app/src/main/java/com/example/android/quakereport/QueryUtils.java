...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link EarthquakeRegistry} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<EarthquakeRegistry> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<EarthquakeRegistry> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                EarthquakeRegistry earthquake = new EarthquakeRegistry(magnitude, location, time, url);
